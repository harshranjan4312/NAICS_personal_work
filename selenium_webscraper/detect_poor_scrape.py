...
#     # Corrected usage of CLASSIFICATION_WEIGHTS keys
#     for phrase in PHRASES:
#         if phrase in text:
#             score += CLASSIFICATION_WEIGHTS.get("has_relevant_phrases", 0)
#             break 

#     for kw in KEYWORDS:
#         if kw in text:
#             score += CLASSIFICATION_WEIGHTS.get("has_relevant_keywords", 0)
#             break 

#     for irrelevant_pattern in IRRELEVANT_PATTERNS:
#         if irrelevant_pattern.search(text):
#             score += CLASSIFICATION_WEIGHTS.get("has_irrelevant_keywords", 0)
#             break

#     for url_pattern in ABOUT_URL_PATTERNS:
#         if url_pattern.search(web_url):
#             score += CLASSIFICATION_WEIGHTS.get("has_about_keyword_in_url", 0)
#             break

#     if "is_short_and_irrelevant" in CLASSIFICATION_WEIGHTS:
#         pass 

#     if "has_contact_form" in CLASSIFICATION_WEIGHTS:
#         pass

#     if "has_social_media_links_only" in CLASSIFICATION_WEIGHTS:
#         pass
    
#     if "is_faq_or_help" in CLASSIFICATION_WEIGHTS:
#         pass

#     if "contains_login_form" in CLASSIFICATION_WEIGHTS:
#         pass
    
#     if "has_uncommon_tld" in CLASSIFICATION_WEIGHTS:
#         parsed_url = urlparse(web_url)
#         tld = parsed_url.netloc.split('.')[-1] if '.' in parsed_url.netloc else ''
#         uncommon_tlds = ["biz", "info", "name", "pro", "xyz", "club", "online", "site", "space"]
#         if tld in uncommon_tlds:
#             score += CLASSIFICATION_WEIGHTS["has_uncommon_tld"]
...
#     # Change this threshold to 0.0
#     GOOD_SCRAPE_THRESHOLD = 0.0 # <--- CHANGE THIS LINE
...
#         print(f"ID: {b['_id']}, Name: {b['company_name']}, Score: {b['score']:.2f}, Snippet: {b['combined_text_snippet']}")
